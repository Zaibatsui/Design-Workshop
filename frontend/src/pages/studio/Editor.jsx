        ...
        <div className="h-14 border-b border-zinc-200 bg-white flex items-center justify-between px-4 gap-4 flex-shrink-0">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            >
              <Input
                ...
                className="font-semibold text-[14px] tracking-tight border border-zinc-200 hover:border-[#E01839] focus-visible:border-[#E01839] focus-visible:ring-0 focus-visible:ring-offset-0 px-3 h-8 py-0 shadow-none rounded-md min-w-0 md:min-w-[180px] max-w-[360px] bg-white hover:bg-red-50/40 transition-colors pr-8"
            ...
            <span className="text-[11px] font-semibold uppercase tracking-wider text-zinc-400 hidden xl:flex items-center gap-1 flex-shrink-0">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            <button
              ...
              className="hidden lg:inline-flex items-center justify-center h-8 w-8 rounded-md text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 transition-colors"
