...
expect("landing copy reflects 26 building blocks",
  /Twenty-six ready-made sections/.test(showcaseSrc));
...
expect("UserGuide updated count to twenty-six",
  /Design Workshop ships twenty-six/.test(guideSrc));
