...
expect("landing copy reflects 24 building blocks",
  /Twenty-four ready-made sections/.test(showcaseSrc));
...
expect("UserGuide updated count to twenty-four",
  /Design Workshop ships twenty-four/.test(guideSrc));
