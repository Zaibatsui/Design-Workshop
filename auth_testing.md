...
# Test protected resources (sections)
curl -X GET "https://your-app.com/api/sections" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X POST "https://your-app.com/api/sections" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"name": "Test Section", "type": "hero", "config": {}}'
```
