...
Run this AFTER import-mongo.sh, INSIDE the new backend container:
    ...
    docker compose exec backend python /app/deploy/scripts/migrate-uploads.py \\
        --source https://section-forge-1.preview.emergentagent.com \\
...
async def main() -> int:
    ...
    ap.add_argument("--source", required=True, help="Old public URL, e.g. https://section-forge-1.preview.emergentagent.com")
